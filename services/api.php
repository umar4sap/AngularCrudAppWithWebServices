<?php
	...
	class API extends REST {
		...
		const DB_USER = "umar";
		const DB_PASSWORD = "Precious786";
		const DB = "code_customer";
		...
		*/
		...
		private function customers(){	
			...
			$query="SELECT distinct c.customerNumber, c.customerName, c.email, c.address, c.city, c.state, c.postalCode, c.country FROM code_customers c order by c.customerNumber desc";
			$r = $this->mysqli->query($query) or die($this->mysqli->error.__LINE__);
